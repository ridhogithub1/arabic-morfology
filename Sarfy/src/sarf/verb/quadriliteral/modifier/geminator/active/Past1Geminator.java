...
public class Past1Geminator extends SubstitutionsApplier implements IQuadrilateralModifier {
    ...
    public Past1Geminator() {
        substitutions.add(new ExpressionInfixSubstitution("úC4óC4ó", "óC4øó")); // EX: (ÇŞúÔóÚóÑøó)
        substitutions.add(new ExpressionInfixSubstitution("úC4óC4õ", "óC4øõ")); // EX: (ÇŞúÔóÚóÑøõæÇ)
    }

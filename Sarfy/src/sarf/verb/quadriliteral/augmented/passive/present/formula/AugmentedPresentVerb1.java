...
public class AugmentedPresentVerb1 extends AugmentedPresentVerb {
     ...
     */
    public String form() {
        return cp+ArabCharUtil.DAMMA+"Ê"+ArabCharUtil.FATHA+root.getC1()+ArabCharUtil.FATHA+root.getC2()+ArabCharUtil.SKOON+root.getC3()+ArabCharUtil.FATHA+root.getC4()+lastDpr+connectedPronoun;
    }
}

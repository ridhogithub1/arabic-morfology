...
public class AugmentedPastVerb10 extends AugmentedPastVerb {
     ...
     */
    public String form() {
        return "«"+root.getC1()+ArabCharUtil.SKOON+root.getC2()+ArabCharUtil.FATHA+"Ê"+ArabCharUtil.SKOON+root.getC2()+ArabCharUtil.FATHA+root.getC3()+lastDpa+connectedPronoun;
    }
}

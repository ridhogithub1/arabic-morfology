...
public class NounFormula2 extends AugmentedQuadriliteralNoun {
     ...
     */
    public String form() {
        return "ã"+ArabCharUtil.DAMMA+root.getC1()+ArabCharUtil.SKOON+root.getC2()+ArabCharUtil.FATHA+"ä"+ArabCharUtil.SKOON+root.getC3()+ArabCharUtil.KASRA+root.getC4()+suffix;
    }
}

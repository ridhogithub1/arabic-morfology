...
public class Geminator1 extends TrilateralNounSubstitutionApplier implements IAugmentedTrilateralModifier {
    ...
    public Geminator1() {
        substitutions.add(new ExpressionInfixSubstitution("úC3óC3","óC3ø"));// EX: (ãõÍóÈøñ¡ ãõÓúÊóÍóÈøñ)
        substitutions.add(new ExpressionInfixSubstitution("C3óC3","C3ø"));// EX: (ãõÍÇÌøñ¡ ãõäúŞóÖøñ¡ ãõÔúÊóÏøñ¡ ãõÊóÕÇãøñ)
    }

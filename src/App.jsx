...
//     try {
//       const response = await fetch('http://localhost:5000/tasrif', {
//         method: 'POST',
...
//                             <span className="label">كلمات مشتقة:</span>
//                             <div className="related-words-list" dir="rtl">
//                               {word.related_words.map((relatedWord, idx) => (
...
//                       {/* 🔹 Tambahkan tombol tasrif di sini */}
//                       <div className="tasrif-buttons">
//                         <button onClick={() => fetchTasrif(word.root, "istilahi")}>
//                           التصريف الاصطلاحي
//                         </button>
//                         <button onClick={() => fetchTasrif(word.root, "lughowiy")}>
//                           التصريف اللغوي
//                         </button>

//                       </div>
//                       {/* 🔹 Tampilkan hasil tasrif kalau root cocok */}
//                       {tasrif && tasrif.root === word.root && (
//                         <div className="tasrif-result">
//                           <h5 dir="rtl">
//                             {tasrif.mode === "istilahi" ? "📘 التصريف الاصطلاحي" : "📗 التصريف اللغوي"}
//                           </h5>
//                           <ul dir="rtl">
